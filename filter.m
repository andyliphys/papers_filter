...
keepQList=ParallelTable[AnyTrue[Join[Table[StringContainsQ[ToString[objectGo[[itemid]]],authorsList[[j]]],{j,1,authorsListLen}],Table[StringContainsQ[ToString[objectGo[[itemid]]],keywordsList[[j]]],{j,1,keywordsListLen}]],TrueQ],{itemid,1,objectGoLen}];
